                                                    ...
                                                    <div>
                                                        <div className="flex flex-col sm:flex-row space-y-6 sm:space-y-0 sm:space-x-6 justify-center formBtns mt-7">
                                                            <button
                                                                ...
                                                                className="redBorder rounded-lg shadow-md redText hover:bg-black hover:text-white hover:border-black text-sm font-medium capitalize px-10 py-3 transition-all duration-300"
                                                            >
                                                                Cancel
                                                            </button>
                                                            <button
                                                                type="submit"
                                                                className="red2Bg rounded-lg shadow-md text-white hover:bg-black text-sm font-medium capitalize px-10 py-3 transition-all duration-300"
                                                            >
                                                                Update
                                                            </button>
                                                        </div>
