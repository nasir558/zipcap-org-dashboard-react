              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <div className="flex-grow commentBox">
                  ...
                  <div className="mt-5 text-right">
                    <button
                      type="submit"
                      className="red2Bg shadow-md rounded-lg text-white hover:bg-black text-sm w-full sm:w-auto font-medium capitalize px-7 py-3.5 transition-all duration-300"
                    >
                      {commentButtonText}
                    </button>
                  </div>
